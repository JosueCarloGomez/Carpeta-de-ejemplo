...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Página principal","1. Ejemplo de busqueda: \"Startup\"","2. Ejemplo \"Estudios sobre la práctica de enfermeria\"","3. Ejemplo \"La quinua\"","4. Ejemplo \"Nanotecnologia\"","5. Ejemplo \"Wikipedia\""],
    DREX_NODE_LINKS: ["index.htm","ejemplo_de_busqueda___startup_.htm","ejemplo__estudios_sobre_la_practica_de_enfermeria_.htm","ejemplo__la_quinua_.htm","ejemplo__nanotecnologia_.htm","ejemplo__wikipedia_.htm"],
    DREX_NODE_CHILD_START: [1,6,6,6,6,6],
    DREX_NODE_CHILD_END: [6,6,6,6,6,6],
    DREX_MENU_TYPE: 2,
